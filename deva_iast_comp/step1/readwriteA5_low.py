...
def adjustlines(lines):
 ...
 # this function removes the accents from neline3a and returns the result.
def remove_accent(newline3a):
 replacements = [('á','a'),('â','a'),("ā́","ā"),('é','e'),('í','i'),('ī́','ī'),('ó','o'),('ú','u'),('ŭ','u'),('ū́','ū')]
 x = newline3a
