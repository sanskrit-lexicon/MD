...
MD is part of the [Sanskrit Lexicon](https://github.com/sanskrit-lexicon) project — corrections and enhancements for the Cologne digitisation of *Monier-Williams Sanskrit–English Dictionary (Digitisation)*.
...
Corrections are never made directly to source files — they are expressed as change files applied by scripts. See [`CLAUDE.md`](https://github.com/sanskrit-lexicon/MD/blob/main/CLAUDE.md) for the change-file format and the `updateByLine.py` workflow.
