"""Synthetic tests for 08_markup_fix.py (MD)."""
...
line, n = fix_trim_whitespace("<lex> word </lex>")
check("<lex> trim", line, "<lex>word</lex>")
check("<lex> trim n>=1", n>=1, True)
line, n = fix_trim_whitespace("<lex>clean</lex>")
check("<lex> no-op", line, "<lex>clean</lex>")
check("<lex> no-op n", n, 0)
